...
pacman::p_load(char = c("tidyverse","data.table", "grid","ggrepel", "pwr", "splitstackshape",
                        "socialmixr","reshape2", "patchwork", "ggpubr", "foreign","forcats", "geosphere", "here", "lubridate"))
